...
if ($isFootball) {
    ...
    $pdfLines = array(
        ...
        'Telefon: ' . $phone, 'E-Mail: ' . $email, '', 'MITGLIEDSCHAFT', 'Abteilung: ' . $departments[$department],
...
$applicantBody = "Hallo {$firstName} {$lastName},\n\n" .
    ...
    ($isFootball ? "Im Anhang findest du den ausgefüllten Spielgenehmigungsantrag sowie die erfasste Unterschrift.\n" : "Im Anhang findest du den erzeugten Mitgliedsantrag sowie die erfasste Unterschrift.\n") .
