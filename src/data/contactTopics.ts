...
export const fixedContactTopics: ContactTopic[] = [
  ...
  { id: 'finance', label: 'Kasse und Finanzen', description: 'Diese Auswahl ist für Rückfragen zu Zahlungen, Rechnungen oder vereinsbezogenen Finanzthemen vorgesehen. Fragen zu Mitgliedsbeiträgen und persönlichen Mitgliedsdaten gehören zur Mitgliederverwaltung.' },
  { id: 'match-operations', label: 'Spielbetrieb', description: 'Nutze diesen Kontakt für übergreifende organisatorische Fragen zum Spielbetrieb, die keiner einzelnen Mannschaft zugeordnet werden können.' },
  { id: 'passwesen', label: 'Passwesen', description: 'Hier kannst du Fragen zu Spielerpässen, Anträgen, Freigaben und weiteren Themen des Passwesens stellen. Nenne bitte Mannschaft, Namen und Geburtsjahr der betreffenden Person.' },
