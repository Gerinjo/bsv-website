...
export const erlebnisCooperations: ErlebnisCooperation[] = [
  ...
  {
    id: 'urmel-bambini-spieltag',
    partner: 'URMEL Bambini Spieltag',
    title: 'Kids spielen für Kids – Bambini-Fußball mit Herz.',
    menuTitle: 'URMEL Bambini Spieltag',
    category: 'Bambini · Benefizspieltag',
    summary: 'Ein fröhlicher Bambini-Spieltag, bei dem Fußball, Gemeinschaft und Hilfe zusammenkommen. Turniergebühren und freiwillige Spenden unterstützen die Urmel Kinder-Krebshilfe e.V.',
    facts: [
      'Kids spielen für Kids',
      'Bambini-Teams aus der Region',
      'Rückblick auf den Benefizspieltag vom 1. Mai 2026',
    ],
    actionLabel: 'Rückblick 2026 ansehen',
    actionHref: '/erlebnis/urmel-bambini-spieltag',
    external: false,
    accent: '#f4d638',
    symbol: '♥',
    logoSrc: '',
    logoAlt: 'URMEL Bambini Spieltag – Kids spielen für Kids',
    logoBackground: '#092f20',
    logoLabel: 'KIDS SPIELEN FÜR KIDS',
    date: '1. Mai 2026',
  },
  {
